...
export default function SolanaExplorer({ blocks, transactions, stats, tokenInfo, isConnected }: SolanaExplorerProps) {
    ...
    <div className="space-y-6">
      {!isConnected && (
        <Alert className="bg-red-900/20 border-red-800 mb-4">
          ...
          <AlertDescription>Unable to connect to Solana network. Showing cached or fallback data.</AlertDescription>
        </Alert>
      )}
        ...
        <Card className="bg-gray-900 border-gray-800">
          <CardHeader className="pb-2">
            <CardTitle className="text-2xl flex items-center">
              ...
              Solana
              <span className="text-sm ml-2 text-gray-400">SOL</span>
            </CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <div className="text-sm text-gray-400">Latest Slot</div>
                <div className="font-medium">{stats?.latestBlock || "Unknown"}</div>
              </div>
              <div>
                <div className="text-sm text-gray-400">TPS</div>
                <div className="font-medium">{stats?.transactionsPerSecond || "Unknown"}</div>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>{formatNumber(stats?.circulatingSupply)} SOL</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-900 border-gray-800">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between">
                    <span className="text-gray-400">Latest Slot</span>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>Proof of History + Proof of Stake</span>
                  </div>
                  <div className="flex justify-between">
            ...
            <CardContent>
              {blocks.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-8">
                  ...
                  {!isConnected && (
                    <p className="text-gray-600 text-sm mt-2">Connection to Solana network is unavailable</p>
                  )}
                </div>
              ) : (
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="hidden md:table-cell">Block Hash</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {blocks.map((block) => (
